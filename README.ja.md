...
Codex Spark Eclipse Legion は、1 人では足りないが大規模オーケストレーターを持ち出すほどでもない場面に向けたスキルです。少人数の Spark サブエージェント部隊を素早く編成し、各担当を明示し、読みやすいカタカナのフルネームと役割に沿った異名を付け、最後に誰が何を担当したかを短く整理して返す流れを Codex に教えます。
...
- 覚えやすく、読みやすく、少し中二病感があり、役割が伝わるフルネームのチームメイト名と異名
